...
```javascript
import FLOAT32_MIN_BASE10_EXPONENT from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-min-base10-exponent@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-min-base10-exponent/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-min-base10-exponent/actions/workflows/test.yml?query=branch:v0.1.1
